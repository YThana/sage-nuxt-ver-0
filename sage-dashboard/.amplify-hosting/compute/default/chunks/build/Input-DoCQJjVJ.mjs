import { defineComponent, computed, useSSRContext, useAttrs, toValue, ref, provide, createElementBlock, getCurrentInstance, inject, cloneVNode, h as h$1, Fragment, toRef, watchEffect, onUnmounted, mergeProps, withCtx, renderSlot, nextTick, createVNode, resolveDynamicComponent, openBlock, createBlock, createCommentVNode, toDisplayString } from 'vue';
import { b as useAppConfig, m as mergeConfig, a as appConfig, _ as _export_sfc, c as useNuxtApp, l as looseToNumber } from './server.mjs';
import { _ as __nuxt_component_0$2 } from './nuxt-link-Cs_hzKNb.mjs';
import { q as defu, z as isEqual } from '../../index.mjs';
import { ssrRenderComponent, ssrRenderSlot, ssrRenderAttrs, ssrRenderVNode, ssrRenderClass, ssrInterpolate } from 'vue/server-renderer';
import { twMerge, twJoin } from 'tailwind-merge';
import __nuxt_component_0$1 from './Icon-BlzFIon0.mjs';
...
let t$2 = Symbol("headlessui.useid"), i$4 = 0;
function I$1() {
  return inject(t$2, () => `${++i$4}`)();
}
function l$1(e) {
  provide(t$2, e);
}
...
var d = (t2, e, r) => e in t2 ? i$3(t2, e, { enumerable: true, configurable: true, writable: true, value: r }) : t2[e] = r;
var n$2 = (t2, e, r) => (d(t2, typeof e != "symbol" ? e + "" : e, r), r);
let s$1 = class s {
  constructor() {
...
function w$2(e, r = 0) {
  var t2;
  return e === ((t2 = i$2(e)) == null ? void 0 : t2.body) ? false : u$1(r, { [0]() {
    return e.matches(c);
  }, [1]() {
    let l2 = e;
    for (; l2 !== null; ) {
...
function w(f, m, l2 = computed(() => true)) {
  ...
  u("pointerdown", (e) => {
    var r, t2;
    l2.value && (u$12.value = ((t2 = (r = e.composedPath) == null ? void 0 : r.call(e)) == null ? void 0 : t2[0]) || e.target);
  }, true), u("mousedown", (e) => {
    var r, t2;
    l2.value && (u$12.value = ((t2 = (r = e.composedPath) == null ? void 0 : r.call(e)) == null ? void 0 : t2[0]) || e.target);
  }, true), u("click", (e) => {
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const uiButton = {
      color: {
        primaryBlue: {
          solid: "shadow-none bg-primaryBlue-50 hover:bg-primaryGray-600 text-black hover:bg-primaryBlue-500 hover:text-white"
        }
      }
    };
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UButton, mergeProps({
        ...
        size: _ctx.size,
        label: _ctx.label,
        class: [_ctx.active && "bg-primaryBlue-500 text-white hover:bg-primaryBlue-500"],
        color: "primaryBlue",
        target: _ctx.target,
        trailing: _ctx.trailing,
        truncate: ""
      }, _attrs), {
        leading: withCtx((_2, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/form/buttons/button-sidebar.vue");
...
export { A, getNuxtLinkProps as B, v$1 as C, _ as D, E, I$1 as I, N, O, P, S$1 as S, T$1 as T, __nuxt_component_4 as _, _sfc_main$1 as a, __nuxt_component_2 as b, __nuxt_component_1 as c, i as d, w$2 as e, N$1 as f, useUI as g, h, i$2 as i, l$1 as j, arrow as k, l, o as m, useId as n, o$1 as o, S as p, c$1 as q, T as r, s2 as s, t, u$1 as u, useFormGroup as v, w, t$1 as x, w$1 as y, dropdown as z };
//# sourceMappingURL=Input-DoCQJjVJ.mjs.map
