import { version, ref, watchEffect, watch, getCurrentInstance, defineAsyncComponent, toRef, isRef, defineComponent, provide, shallowReactive, h, inject, Suspense, nextTick, Transition, unref, useSSRContext, createApp, effectScope, reactive, hasInjectionContext, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, isReadonly, computed, isShallow, isReactive, toRaw, mergeProps } from 'vue';
import { d as useRuntimeConfig$1, $ as $fetch, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, j as joinURL, n as defuFn, o as klona, q as defu, r as sanitizeStatusCode, t as createDefu, v as createHooks, h as createError$1, x as toRouteMatcher, y as createRouter$1 } from '../../index.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./chat-SvL3kzXF.mjs').then((m) => m.default || m)
  },
  {
    name: "chat-scada",
    path: "/chat-home",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-CDH_dTFU.mjs').then((m) => m.default || m)
  },
  {
    name: "dashboard",
    path: "/home",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-caj_mGdE.mjs').then((m) => m.default || m)
  },
  {
    name: "home",
    path: "/home",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-DtHoHvtv.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-Baj-Y3Ux.mjs').then((m) => m.default || m)
  },
  {
    name: "user-profile",
    path: "/user-profile",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-BD7VpKGs.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-BlzFIon0.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-BkDoDJiU.mjs').then((r) => r.default));
...
const _primaryBlue = { "50": "#F8F9FF", "100": "#EDEFFF", "200": "#DEE2FF", "300": "#B2B5EF", "400": "#9EA2FC", "500": "#7774FF", "600": "#6A5BF9", "700": "#5B3DEE", "800": "#4F2FD3", "900": "#4029AA", "950": "#372986" };
const _secondaryBlue = { "50": "#f1f7fd", "100": "#eef5fc", "200": "#ebf3fc", "300": "#e9f1fb", "400": "#e6f0fb", "500": "#e3eefa", "600": "#c7def6", "700": "#a1caef", "800": "#74ade6", "900": "#548fdd", "950": "#3f74d1" };
const _primaryGray = { "50": "#F3F7F8", "100": "#E0E9ED", "200": "#C5D4DC", "300": "#9DB7C3", "400": "#6E90A2", "500": "#527488", "600": "#476073", "700": "#3E5260", "800": "#394651", "900": "#333D46", "950": "#232C35" };
const _icon = "#55555599";
const _containerBorder = "#c7c7c733";
const _selected = "#8a8a8a40";
const _placeholder = "#ABABAB";
const _sidebarListTitle = "#8A8A8A";
const _inputBorder = "#dddee080";
const _chatBg = "#ababac26";
...
const config = { "inherit": _inherit, "current": _current, "transparent": _transparent, "black": _black, "white": _white, "slate": _slate, "gray": _gray, "zinc": _zinc, "neutral": _neutral, "stone": _stone, "red": _red, "orange": _orange, "amber": _amber, "yellow": _yellow, "lime": _lime, "green": _green, "emerald": _emerald, "teal": _teal, "cyan": _cyan, "sky": _sky, "blue": _blue, "indigo": _indigo, "violet": _violet, "purple": _purple, "fuchsia": _fuchsia, "pink": _pink, "rose": _rose, "primaryBlue": _primaryBlue, "secondaryBlue": _secondaryBlue, "primaryGray": _primaryGray, "icon": _icon, "containerBorder": _containerBorder, "selected": _selected, "placeholder": _placeholder, "sidebarListTitle": _sidebarListTitle, "inputBorder": _inputBorder, "chatBg": _chatBg, "primary": _primary, "cool": _cool };
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DpdkFdy8.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-Bb9YS-_l.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, appConfig as a, useAppConfig as b, useNuxtApp as c, useRouter as d, entry$1 as default, useRuntimeConfig as e, navigateTo as f, useState as g, looseToNumber as l, mergeConfig as m, nuxtLinkDefaults as n, useHead as u };
